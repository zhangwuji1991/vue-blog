      ...
      <transition name="silde-bottom">
        <div class="search_select" v-show="showSearch">
          <div class="select_type">
            ...
            <span class="select_span" @click.stop="clickSearchMusic($event)">成都</span>
            <span class="select_span" @click.stop="clickSearchMusic($event)">see you again</span>
            <span class="select_span" @click.stop="clickSearchMusic($event)">南山忆</span>
            <span class="select_span" @click.stop="clickSearchMusic($event)">七里香</span>
            <span class="select_span" @click.stop="clickSearchMusic($event)">东凤破</span>
   
            <span class="select_span" @click.stop="clickSearchMusic($event)">好久不见</span>
            <span class="select_span" @click.stop="clickSearchMusic($event)">庐州月</span>
            <span class="select_span" @click.stop="clickSearchMusic($event)">南山忆</span>
            <span class="select_span" @click.stop="clickSearchMusic($event)">夕阳之歌</span>
            <span class="select_span" @click.stop="clickSearchMusic($event)">相思</span>
          </div>
          <div class="select_type">
