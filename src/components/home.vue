...
export default {
  ...
  computed: {
    bingImageDisc () {
      return store.getters.getGlobalInfo.showBingImage ? '每日一图由 bing 提供 | Copyright © 2016~2017 DAIWEI.ORG' : '每日一图由 走过你的时光 提供 | Copyright © 2016~2017 DAIWEI.ORG'
    },
    imageInfo () {
  ...
  methods: {
    ...
    bingData () {
      ...
      // const getbingApi = '../static/imgdata.json'
